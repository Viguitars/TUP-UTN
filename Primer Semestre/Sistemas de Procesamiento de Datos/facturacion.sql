...
SET 
  time_zone = "+00:00";
DROP 
  DATABASE IF EXISTS `facturacion`;
...
INSERT INTO `articulos` (
  `codart`, `detalle`, `unidad`, `puv`, 
  `iva`, `stock`
) 
VALUES 
  (
    200, 'Tornillo rosca madera 1x20', 
    'un', 35, 0.21, 500
  ), 
  (
    300, 'Masilla sintética uso madera', 
    'kg', 1580, 0.21, 20
  ), 
  (
    400, 'Somier 1 1/2 plaza', 'un', 35000, 
    0.21, 5
  ), 
  (
    500, 'silla metálica tapizada gris', 
    'un', 2500, 0.21, 20
  ), 
  (
    502, 'Silla de roble color natural estilo Luis XV', 
    'un', 19000, 0.21, NULL
  ), 
  (
    503, 'Silla laqueda color blanco', 
    'un', 16800, 0.21, NULL
  ), 
  (
    600, 'Mesa circular tapa de vidrio', 
    'un', 15246, 0.21, 3
  ), 
  (
    601, 'Mesa rectangular de madera de roble color natural', 
    'un', 28921, 0.21, 1
  ), 
  (
    605, 'Barniz color cedro x 1 ', 'lt', 
    2500, 0.15, 50
  ), 
  (
    606, 'Barniz color cedro x 2', 'lt', 
    2600, 0.15, NULL
  );
-- --------------------------------------------------------
--
...
--
INSERT INTO `factura` (
  `nrofact`, `codcliente`, `fecha`, 
  `hora`, `codven`
) 
VALUES 
  (
    1000, 100, '2023-03-29 00:00:00', 
    '10:00:00', 1
  ), 
  (
    1001, 101, '2023-03-29 00:00:00', 
    '10:15:00', 4
  ), 
  (
    1002, 102, '2023-03-30 00:00:00', 
    '10:20:00', 2
  ), 
  (
    1003, 101, '2023-03-30 00:00:00', 
    '09:20:00', 3
  ), 
  (
    1004, 102, '2023-03-29 00:00:00', 
    '09:00:00', 4
  ), 
  (
    1005, 104, '2023-03-30 00:00:00', 
    '09:10:00', 1
  ), 
  (
    1006, 101, '2023-04-01 00:00:00', 
    '10:30:00', 1
  ), 
  (
    1007, 103, '2023-04-01 00:00:00', 
    '10:35:00', 3
  ), 
  (
    1008, 105, '2023-04-01 00:00:00', 
    '11:00:00', 4
  ), 
  (
    1010, 102, '2023-03-23 00:00:00', 
    '09:00:00', 2
  ), 
  (
    1011, 108, '2023-04-12 00:00:00', 
    '10:00:00', 4
  );
-- --------------------------------------------------------
--
...
--
INSERT INTO `transportes` (`codtransp`, `nombretransporte`) 
VALUES 
  (1, 'Buenos Aires'), 
  (2, 'El cordobés'), 
  (3, 'Independencia'), 
...
ALTER TABLE 
  `envios` 
ADD 
  PRIMARY KEY (`codtransp`, `codpostal`);
--
